...
- Namun jika kita meng-set JAN menjadi 1 misalnya, maka FEB akan menjadi 2 \*_/
  enum MonthOther {
  JAN = 1,
  FEB,
  MAR = 100,
...
/\*_ constructor promote property _/
export class Person {
...
/\*_ Karena class List bertipe generic, kita perlu memberitahukan type List nya pada saat instansiasi object nya _/
...
/\*_ Beginilah cara agar class List bisa menampung data berupa number maupun string _/
